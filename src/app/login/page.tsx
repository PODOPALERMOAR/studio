          ...
          <main className="flex-grow flex items-center justify-center bg-background p-4">
              <Card className="w-full max-w-md mx-auto shadow-lg">
                  <CardHeader className="text-center">
                      <CardTitle className="text-2xl font-headline">Accedé a tu Cuenta</CardTitle>
                      <CardDescription>
                          Continuá con Google o tu celular para gestionar tus turnos.
                      </CardDescription>
                  </CardHeader>
                  <CardContent className="space-y-4">
                      ...
                      <p className="text-xs text-center text-muted-foreground px-4">
                          ...
                          <Link href="/terms" className="underline hover:text-primary">Términos de Servicio</Link>.
                      </p>
                  </CardContent>
              </Card>
          </main>
